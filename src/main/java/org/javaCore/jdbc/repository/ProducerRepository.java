    ...
    private static void preparedStatementSaveTransaction(Connection conn, List<Producer> producers) throws SQLException {
        ...
        for (Producer p : producers) {
            try (PreparedStatement ps = conn.prepareStatement(sql)) {
                ...
                e.printStackTrace();
                log.warn("Transaction being rolledback!");
                shouldRollback = true;
            }
        }
...
//                rs.cancelRowUpdates(); // usado para cancelar o update, mas deve ser usando ANTES do updateRow
                rs.updateRow();
                Producer producer = Producer
                        .builder()
                        .id(rs.getInt("id"))
    ...
    public static List<Producer> findByNamePreparedStatement(String name) {
        log.info("Finding Producers by name PreparedStatement.");
        List<Producer> producers = new ArrayList<>();
        try (Connection conn = ConnectionFactory.getConnection();
