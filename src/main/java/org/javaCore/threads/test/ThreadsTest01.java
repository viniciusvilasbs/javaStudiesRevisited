...
//            Coloca a Thread para "dormir" por tempo determinado em milisegundos (no exemplo está para esperar 2 segundos)
           /*
           try {
                Thread.sleep(2000);
...
//        define a prioridade que vc deseja que a Thread seja executada, de 1 a 10, ou MIN, NORMAL ou MAX
//        (NÃO HÁ GARANTIA QUE SERÁ RESPEITADO!)
